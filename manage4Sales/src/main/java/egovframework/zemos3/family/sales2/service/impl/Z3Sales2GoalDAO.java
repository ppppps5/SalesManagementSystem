 ...
 *  </pre>
 */
@Repository("z3Sales2GaolDAO")
public class Z3Sales2GaolDAO extends ZenielMAbstractDAO {
	...
	public List<Map<String, Object>> selectYyyy(Map<String, Object> params) throws Exception {
    	return selectList("zenielm.zemos3.family.sales2.sales2Goal.selectYyyy", params);
	}
	...
	public List<Map<String, Object>> selectBoxStoreList(Map<String, Object> params) throws Exception {
    	return selectList("zenielm.zemos3.family.sales2.sales2Goal.selectBoxStoreList", params);
	}
	...
	public int selectGoalCnt(Map<String, Object> params) throws Exception {
    	return selectOne("zenielm.zemos3.family.sales2.sales2Goal.selectGoalCnt", params);
	}
	...
	public int selectGoalCnt01(Map<String, Object> params) throws Exception {
    	return selectOne("zenielm.zemos3.family.sales2.sales2Goal.selectGoalCnt01", params);
	}
	...
	public List<Map<String, Object>> selectGoal(Map<String, Object> params) throws Exception {
    	return selectList("zenielm.zemos3.family.sales2.sales2Goal.selectGoal", params);
	}
	
	public List<Map<String, Object>> selectUnit(Map<String, Object> params) throws Exception {
    	return selectList("zenielm.zemos3.family.sales2.sales2Goal.selectUnit", params);
	}
	
	public List<Map<String, Object>> selectOnoff(Map<String, Object> params) throws Exception {
    	return selectList("zenielm.zemos3.family.sales2.sales2Goal.selectOnoff", params);
	}
	...
	public List<Map<String, Object>> selectExcelDown(Map<String, Object> params) throws Exception {
    	return selectList("zenielm.zemos3.family.sales2.sales2Goal.selectExcelDown", params);
	}
	...
	public List<Map<String, Object>> selectTotSumGoal(Map<String, Object> params) throws Exception {
    	return selectList("zenielm.zemos3.family.sales2.sales2Goal.selectTotSumGoal", params);
	}
	...
	public List<Map<String, Object>> selectGoalDetail(Map<String, Object> params) throws Exception {
		return selectList("zenielm.zemos3.family.sales2.sales2Goal.selectGoalDetail", params);
	}
	...
	public int goalUpdate(Map<String, Object> params) throws Exception {
		return update("zenielm.zemos3.family.sales2.sales2Goal.goalUpdate", params);
	}
	...
	public List<Map<String, Object>> selectStoreNm(Map<String, Object> params) throws Exception {
    	return selectList("zenielm.zemos3.family.sales2.sales2Goal.selectStoreNm", params);
	}
	/**
	 * UNIT의 SEQ 계산
	 * @param params
	...
	public List<Map<String, Object>> selectUnitList(Map<String, Object> params) throws Exception {
    	return selectList("zenielm.zemos3.family.sales2.sales2Goal.selectUnitList", params);
	}
	...
	public List<Map<String, Object>> selectUnitList01(Map<String, Object> params) throws Exception {
    	return selectList("zenielm.zemos3.family.sales2.sales2Goal.selectUnitList01", params);
	}
	...
	public int deleteGoal(Map<String, Object> params) throws Exception {
    	return delete("zenielm.zemos3.family.sales2.sales2Goal.deleteGoal", params);
	}
	...
	public int insertGoal(Map<String, Object> params) throws Exception {
    	return insert("zenielm.zemos3.family.sales2.sales2Goal.insertGoal", params);
	}
	...
	public int updateGoal(Map<String, Object> params) throws Exception {
		return update("zenielm.zemos3.family.sales2.sales2Goal.updateGoal", params);
	}
	...
	public List<Map<String, Object>> selectitemList(Map<String, Object> params) throws Exception {
		return selectList("zenielm.zemos3.family.sales2.sales2Goal.selectitemList", params);
	}
}
