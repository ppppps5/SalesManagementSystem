 ...
 *  </pre>
 */
@Service("z3Sales2MainService")
public class Z3Sales2MainServiceImpl extends EgovAbstractServiceImpl implements Z3Sales2MainService {
	...
	//메인 DAO
	@Resource(name = "z3Sales2MainDAO")
	private Z3Sales2MainDAO z3Sales2MainDAO;
