 ...
 *  </pre>
 */
@Service("z3Sales2Class1Service")
public class Z3Sales2Class1ServiceImpl extends EgovAbstractServiceImpl implements Z3Sales2Class1Service {
	...
	//분류1 DAO
	@Resource(name = "z3Sales2Class1DAO")
	private Z3Sales2Class1DAO z3Sales2Class1DAO;
	
	/**
	 *분류1 count
	 */
	public int selectSales2Class1Cnt(Map<String, Object> params) throws Exception {
		return z3Sales2Class1DAO.selectSales2Class1Cnt(params);
	}
	...
	public List<Map<String, Object>> selectSales2Class1(Map<String, Object> params) throws Exception {
		return z3Sales2Class1DAO.selectSales2Class1(params);
	}
	
	public List<Map<String, Object>> selectClass1NameList(Map<String, Object> params) throws Exception {
		return z3Sales2Class1DAO.selectClass1NameList(params);
	}
	...
	public List<Map<String, Object>> selectSales2Class01(Map<String, Object> params) throws Exception {
		return z3Sales2Class1DAO.selectSales2Class01(params);
	}
	...
	public int class1Insert(Map<String, Object> params) throws Exception {
		return z3Sales2Class1DAO.class1Insert(params);
	}
	...
	public int class1Update(Map<String, Object> params) throws Exception {
		return z3Sales2Class1DAO.class1Update(params);
	}
