 ...
 */
@Controller
public class Z3Sales2RequestAdminController {

	private static final Logger LOGGER = LoggerFactory.getLogger(Z3Sales2RequestAdminController.class);
	...
	//수정요청관리 Service
	@Resource(name = "z3Sales2RequestAdminService")
	private Z3Sales2RequestAdminService z3Sales2RequestAdminService;
