	...
	$.extend( $.mobile.datebox.prototype._build, {
		...
		'datebox': function () {
			var w = this,
				...
				inBase = $("<input type='"+w.inputType+"' />").addClass('ui-input-text ui-body-'+o.themeInput),
				inBaseT = $("<input type='text' />").addClass('ui-input-text ui-body-'+o.themeInput),
				butBase = $("<div></div>"),
				butPTheme = {theme: o.themeButton, icon: 'plus', iconpos: 'bottom', corners:false, shadow:false, inline:true},
