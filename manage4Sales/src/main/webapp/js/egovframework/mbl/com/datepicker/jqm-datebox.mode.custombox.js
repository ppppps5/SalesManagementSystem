	...
	$.extend( $.mobile.datebox.prototype._build, {
		'custombox': function () {
			var w = this,
				...
				inBase = $("<input type='text' />").addClass('ui-input-text ui-body-'+o.themeInput),
				inDiv = $("<div>").addClass('ui-input-text ui-body-'+o.themeInput).css({'padding':'.4em','margin':'.5em 0','text-align':'center'}),
				butBase = $("<div>"),
				butPTheme = {theme: o.themeButton, icon: 'plus', iconpos: 'bottom', corners:false, shadow:false},
			...
			if ( o.useSetButton || o.useClearButton ) {
				...
				if ( o.useSetButton ) {
					$('<a href="#">'+w.__('customSet')+'</a>')
						.appendTo(y).buttonMarkup({theme: o.theme, icon: 'check', iconpos: 'left', corners:false, shadow:false})
				...
				if ( o.useClearButton ) {
					$('<a href="#">'+w.__('clearButton')+'</a>')
						.appendTo(y).buttonMarkup({theme: o.theme, icon: 'delete', iconpos: 'left', corners:false, shadow:false})
						.on(o.clickEventAlt, function(e) {
							e.preventDefault();
							w.d.input.val('');
